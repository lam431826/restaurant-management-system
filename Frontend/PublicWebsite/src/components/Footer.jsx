export default function Footer() {
  return (
    <div className="border border-[rgba(239,231,210,0.15)] rounded-2xl flex items-center justify-center px-6 py-5">
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-[50px] flex-wrap justify-center text-center md:text-left">
        <span className="text-[#efe7d2] text-sm leading-[1.5]" style={{ fontFamily: "'MJ Satoshi', sans-serif" }}>
...
function Diamond() {
  return (
    <div className="hidden md:flex items-center justify-center size-[11.3px] shrink-0">
