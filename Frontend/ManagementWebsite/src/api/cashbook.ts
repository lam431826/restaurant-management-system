...
// separate invoice recap. invoiceId is the real Invoice UUID (sourceReferenceId),
// suitable for both display (via formatInvoiceCode) and navigation to /manager/invoices.
...
const mapVoucher = (dto: VoucherResponseDto): CashFlowVoucher => ({
  ...
  voided: dto.voided,
  sourceInvoice: dto.sourceType === 'INVOICE_PAYMENT' && dto.sourceReferenceId ? {
