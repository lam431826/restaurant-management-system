...
import { BRANCHES, CATEGORY_LINE_INSERT_AFTER, FIN_LINES, sumCategoryLineValues, sumValues } from '../../data/financialReport'
import type { FinancialCategoryLine, FinancialFilterState, FinancialPeriod } from '../../data/financialReport'
