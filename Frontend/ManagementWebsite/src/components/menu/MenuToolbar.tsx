    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button className={iconBtn} aria-label="Trợ giúp" title="Định dạng CSV: code,name,category,price,costPrice,description,imageUrl,menuType,itemType,tag,trackStock,status">
