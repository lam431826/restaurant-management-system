...
const icon = (size = 16, color = 'currentColor', strokeWidth = 2, children: ReactNode) => (
  <svg
...
export const IconChevronDown = ({ size = 16, color = 'currentColor', strokeWidth = 2 }: IconProps) =>
  icon(size, color, strokeWidth, <polyline points="6 9 12 15 18 9" />)
...
export const IconConciergeBell = ({ size = 16, color = 'currentColor', strokeWidth = 2 }: IconProps) =>
  icon(size, color, strokeWidth, <>
    ...
    <path d="M10 10V9a2 2 0 1 1 4 0v1" />
