        ...
        <div className="relative" ref={ref}>
          ...
          {open && (
            <div className="absolute right-0 top-full mt-2 bg-white border border-[#e8e8e8] rounded-[12px] shadow-lg w-[200px] py-1 z-50">
              ...
              {shiftClosingEnabled && shift && (
                <>
                  {shift.status === "PENDING_MANAGER_CONFIRM" ? (
                    <div className="flex items-center gap-2 w-full px-4 py-2.5 text-[14px] text-[#9499a0] cursor-not-allowed">
                      <svg
                        className="w-4 h-4"
                        fill="none"
                        stroke="currentColor"
